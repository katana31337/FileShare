...
### 🎨 Русскоязычный вывод с цветами

Все тесты выводятся на русском языке с цветовым выделением:
- 🟢 **Зелёный** - пройденные тесты
- 🔴 **Красный** - проваленные тесты
- 🟡 **Жёлтый** - пропущенные тесты
- 🔵 **Синий** - заголовки наборов тестов

Пример вывода:
```
═══════════════════════════════════════════════════════════
  🧪 Запуск тестов QuickShare
═══════════════════════════════════════════════════════════

  ✓ ПРОЙДЕН должен генерировать 8-символьный ID по умолчанию (2ms)
  ✓ ПРОЙДЕН должен генерировать уникальные ID (5ms)
  ✗ ПРОВАЛЕН должен отклонять слишком короткие ID (1ms)
...
```bash
# Запустить все тесты (краткий вывод)
npm test

# Запустить все тесты (подробный вывод с деталями ошибок)
npm run test:full
...
- Показывает только список проваленных тестов
- Общую статистику (пройдено/провалено/всего)
- Время выполнения
- Рекомендуется для быстрого просмотра результатов

**Подробный режим** (`--full`):
- Показывает все пройденные тесты с временем выполнения
- Детальные сообщения об ошибках для проваленных тестов
- Список пропущенных тестов
- Рекомендуется для отладки и анализа ошибок
